...
public class TaxEntry {
	...
	public TaxEntry(com.ttb.service.taxburden.domain.TaxEntry clientTaxEntry) {
		super();
		this.setTaxType(TaxType.valueOf(clientTaxEntry.getTaxType().name()));
		this.politicalDivision = new PoliticalDivision(clientTaxEntry.getPoliticalDivision());
		this.description = clientTaxEntry.getDescription();
		this.amount = new MonetaryAmount(clientTaxEntry.getAmount());
	}
