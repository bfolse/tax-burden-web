...
public class PoliticalDivision {
	...
	public PoliticalDivision(com.ttb.service.taxburden.domain.PoliticalDivision clientPoliticalDivision) {
		super();
		this.fips = clientPoliticalDivision.getFips();
		this.name = clientPoliticalDivision.getName();
		this.description = clientPoliticalDivision.getDescription();
		this.setType(PoliticalDivisionType.valueOf(clientPoliticalDivision.getType().name()));
	}
